            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Coulis list {{ $colis->count() }}</h6>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif ($coli->statue == 1)
                                                    <p class="btn btn-success"><i class="fa-solid fa-check"></i></p>
                                                @elseif ($coli->statue == 2)
                                                    <p class="btn btn-danger"><i class="fa-solid fa-xmark"></i></p>
                                                @elseif ($coli->statue == 3)
                                                    <p class="btn btn-success"><i class="fa-solid fa-box-check"></i></p>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="d-flex">
